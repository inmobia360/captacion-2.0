...
<head>
  ...
  <title><?php echo htmlspecialchars($record['title']); ?> | Compra Captación</title>
  ...
  <meta property="og:title" content="<?php echo htmlspecialchars($record['title']); ?> | Compra Captación">
  ...
  <meta name="twitter:title" content="<?php echo htmlspecialchars($record['title']); ?> | Compra Captación">
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-[#162e26] text-white rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h3 class="text-lg font-bold"><?php echo htmlspecialchars($displayAgent['name']); ?></h3>
              <p class="text-xs text-[#9bb0a7] font-bold"><?php echo htmlspecialchars($displayAgent['agency']); ?></p>
